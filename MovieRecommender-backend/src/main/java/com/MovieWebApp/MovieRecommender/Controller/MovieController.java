...
public class MovieController {
    ...
    @CrossOrigin
    @GetMapping("/search")
    public List<Movie> searchForMovie(@RequestParam("name") String movieName, @RequestParam("numMovies") int numMovies){
        return movieService.searchForMovie(movieName, numMovies);
    }
